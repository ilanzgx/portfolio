...
<div class="grid grid-cols-1 md:grid-cols-2 gap-4 not-prose my-6">
  <img src="/portfolio/images/projects/ecommerce-laravel/image_1.png" alt="Vitrine do E-commerce" class="w-full h-full object-cover rounded-lg border border-black/10 dark:border-white/10 !m-0" data-zoomable />
  <img src="/portfolio/images/projects/ecommerce-laravel/image_2.png" alt="Carrinho de Compras" class="w-full h-full object-cover rounded-lg border border-black/10 dark:border-white/10 !m-0" data-zoomable />
  <img src="/portfolio/images/projects/ecommerce-laravel/image_3.png" alt="Dashboard Administrativo" class="col-span-1 md:col-span-2 w-full h-auto object-cover rounded-lg border border-black/10 dark:border-white/10 !m-0" data-zoomable />
</div>
